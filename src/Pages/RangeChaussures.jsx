			...
			<div className="single-product">
							...
							<div className="product-content">
								...
								<div className="product-price">
									<span className="old">7000FCFA</span>
									<span>5900FCFA</span>
								</div>
							</div>
						</div>
						...
						<div className="single-product">
                            ...
                            <div className="product-content">
                                <h3><Link to="product-details.html">Armoire à Chaussures Meuble de Rangement pour 24 Paires</Link></h3>
                                <div className="product-price">
                                    <span>22900FCFA</span>
                                </div>
                            </div>
						...
						<div className="single-product">
                            <div className="product-img">
                                <Link to="product-details.html">
                                    ...
                                    <img className="hover-img"  src="https://i1.wp.com/www.mondialevaise.com/wp-content/uploads/2021/10/15554f25-0881-4651-8e8c-374c990ad870.jpg?fit=720%2C720&ssl=10" alt="#" />
                                </Link>
								<div className="button-head">
									<div className="product-action">
...
export default RangeChaussures
